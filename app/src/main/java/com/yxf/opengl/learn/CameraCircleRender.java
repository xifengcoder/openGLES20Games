...
public class CameraCircleRender implements GLSurfaceView.Renderer {
    ...
    public CameraCircleRender(final Context activityContext) {
    ...
    protected String getVertexShader() {
        return ShaderUtil.loadFromAssetsFile(mContext, R.raw.vertex_shader);
    }

    protected String getFragmentShader() {
        return ShaderUtil.loadFromAssetsFile(mContext, R.raw.fragment_shader);
    }
    ...
    public void onSurfaceCreated(GL10 glUnused, EGLConfig config) {
        ...
        mTextureID = TextureUtil.initTexture(mContext, R.drawable.face1);
    }
