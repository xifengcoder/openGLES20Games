...
public class Cylinder {
    ...
    public Cylinder(MySurfaceView mySurfaceView, float scale, float radius, float h, int n,
        ...
        topCircle = new Circle(mySurfaceView, scale, radius, n);    //创建顶面圆对象
        bottomCircle = new Circle(mySurfaceView, scale, radius, n);  //创建底面圆对象
        cylinderSide = new CylinderSide(mySurfaceView, scale, radius, h, n); //创建侧面无顶圆柱对象
    }
